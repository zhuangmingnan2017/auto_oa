...
<div class="row">
    <ul style="text-decoration: none;">
        <li><button class="btn btn-primary" onclick="javascript:$('#addPermissionModal').show(1000);">添加用户</button></li>
    </ul>
</div>
<%--权限列表--%>
<div class="row">
        ...
        <c:forEach items="${userList}" var="item" varStatus="status">
            <tr style="cursor: pointer" id="user_tr_${item.id}"}>
                ...
                <td>
                    ...
                    <button class="btn btn-primary btn-sm">编辑用户信息</button>
                    <button class="btn btn-danger btn-sm">删除用户信息</button>
                </td>
            </tr>
        </c:forEach>
        </tbody>
