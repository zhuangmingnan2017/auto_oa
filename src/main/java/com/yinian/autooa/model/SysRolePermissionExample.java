...
public class SysRolePermissionExample {
    ...
    /**
     *  获取当前的查询条件实例,sys_role_permission
     */
    ...
    /**
     *  内部构建查询条件对象,sys_role_permission
     */
